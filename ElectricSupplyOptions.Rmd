...
data_files <- list.files("NYSISO_data") # Identify file names
for(i in 1:length(data_files)) {        # Head of for-loop
  assign(paste0("ISO_Data", i),    # Read and store data frames
         read_csv(paste0("NYSISO_data/",
                   data_files[i]), col_names = TRUE, col_types = NULL))}
###### Up to here 



nyiso <- read_csv("data/OASIS_Day-Ahead_Market_Zonal_LBMP.csv")
