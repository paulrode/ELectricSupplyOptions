...
<u>Figure 10</u> This chart show the affect on annual performance of the three strategies given a 2014 like polar vortex. 
...
<u>Table 3</u> This is the data table used to develop the annual comparative bar chart in Figure 10. 


<u>Table 4</u> This is the data table used to develop the annual comparative bar chart in Figure 10. 
...
Annual_Cost_Estimates_Run %>% 
  ...
  geom_col(aes(fill = Strategy)) +
  theme_classic() +
    labs(x = "Strategy", y = "Annual Cost($)", title = "Figure 10:" ~underline("Comparision of Strategies under a Polar Vortex Hit"))
...
kable(Annual_Cost_Estimates_Run, format = 'html',
      ...
      digits = 0,
      align = 'll',
      caption = "Table 3: Annual Estimates of spend by strategy") %>% 
  kable_styling(bootstrap_options = "striped",
                full_width = F) %>%
  footnote(c("2023 Electric Supply Options"))
